...
// and access anything the user explicitly picks via the Picker — it does NOT
// grant blanket access to a teacher's whole Drive.
...
export async function fetchPublicDriveFile(fileId) {
  ...
  if (!res.ok) throw new Error("Could not load this file from Google Drive. It may not be shared publicly.");
