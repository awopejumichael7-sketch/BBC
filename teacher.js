...
import { openDrivePicker, makeFilePublic, verifyPublicAccess, driveFileViewUrl, uploadFileToDrive } from "./drive-config.js";
...
function renderMaterials() {
  ...
  document.getElementById("mat-form").addEventListener("submit", async (e) => {
    ...
    if (dest === "storage") {
      ...
      prog.innerHTML = "Linking Google Drive file…";
      try {
        ...
        loadMaterialsList();
      } catch (err) { toast(err.message, "error"); prog.innerHTML = ""; }
    }
  });
