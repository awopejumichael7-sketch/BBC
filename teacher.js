...
function renderLive() {
  ...
  main.innerHTML = `
    ...
    <p style="color:var(--muted);font-size:.85rem;margin-top:10px;">
      <i class="fa-solid fa-circle-info"></i> This is a live, real-time broadcast — nothing is recorded or saved. Students on the Live Class tab of this course will see it the moment you go live.
    </p>`;

  if (isLive) document.getElementById("live-preview").srcObject = liveStream;
